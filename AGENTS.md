...
- OpenAI GPT / Anthropic Codex for AI generation
...
- **Dual AI support**: OpenAI GPT or Anthropic Codex (env configurable)
- **Chat types**:
  - 1-on-1 (2 characters)
...
| `ai_service.py` | AI generation with OpenAI/Codex, supports "auto" genre/mood |
...
│   ├── ai_service.py              <- AI generation (OpenAI/Codex)
